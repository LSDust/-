...
module.exports = class Incubator{
    ...
    constructor() {
        ...
        this.Miners_W3S23_G1   = _.filter(Game.creeps, (creep) => creep.memory.role == 'Miner'      && creep.memory.workshop == 'W3S23' && creep.memory.group == 1  && (creep.ticksToLive > 80 || creep.spawning));
        ...
        this.Miners_W3S22_G1   = _.filter(Game.creeps, (creep) => creep.memory.role == 'Miner'      && creep.memory.workshop == 'W3S22' && creep.memory.group == 1  && (creep.ticksToLive > 120 || creep.spawning));
        //运输   
        ...
        this.Carriers_W2S23_G1 = _.filter(Game.creeps, (creep) => creep.memory.role == 'Carrier'    && creep.memory.workshop == 'W2S23' && creep.memory.group == 1  && (creep.ticksToLive > 30 || creep.spawning));
        ...
        this.Carriers_W3S22_G1 = _.filter(Game.creeps, (creep) => creep.memory.role == 'Carrier'    && creep.memory.workshop == 'W3S22' && creep.memory.group == 1  && (creep.ticksToLive > 60 || creep.spawning));
        this.Carriers_power    = _.filter(Game.creeps, (creep) => creep.memory.role == 'Carrier_p'  && creep.memory.workshop == 'E0S24' && creep.memory.group == 0  && (creep.ticksToLive > 30 || creep.spawning));
        //综合   
        ...
        //过道
        this.DepositsHarvesters= _.filter(Game.creeps, (creep) => creep.memory.role == 'DepositsHarvester' && creep.memory.workshop == 'E0S24'  );
    }
    //#endregion
    ...
    w1S22Spawn1Incubator(spawn){
        if(this.Incubator_Level < 1 ){
            //过道
            if(this.DepositsHarvesters.length < 0 ) {
            ...
            if(this.reservers_W1S23.length < 1 && (!Game.rooms['W1S23'] || Game.rooms['W1S23'].controller.reservation.ticksToEnd < 1000)) {
                ...
                spawn.spawnCreep([CLAIM,CLAIM,CLAIM,CLAIM,MOVE,MOVE], newName, {memory: {role: 'reserver',workshop: 'W1S23'}});
            }
            //全能者
            ...
            if(this.Builders_W1S22.length < 1 ) {
                ...
                console.log('孵化新的 Builder: ' + newName);
                spawn.spawnCreep([WORK,WORK,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE], newName, {memory: {role: 'Builder', workshop: 'W1S22',birthroom:'W1S22', group: 0}});
            }
        }
        ...
        }
        {
            ...
            if(this.Carriers_power.length < 0 ){
                ...
                console.log('孵化新的 Carrier: ' + newName);
                spawn.spawnCreep([CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE], newName, {memory: {role: 'Carrier_p',workshop: 'E0S24', birthroom:'W1S22',group :0, taking: true}});
            }
            if(this.Attackers.length < 0 ) {
                var newName = 'Attacker_' + Game.time;
                console.log('孵化新的 Attacker: ' + newName);
                spawn.spawnCreep([MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,ATTACK,ATTACK,ATTACK,ATTACK,ATTACK,ATTACK,ATTACK,ATTACK,ATTACK,ATTACK,ATTACK,ATTACK,ATTACK,ATTACK], newName, {memory: {role: 'Attacker',workshop: 'E0S24'}});
                // spawn.spawnCreep([CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE], newName, {memory: {role: 'Attacker',workshop: 'W1S22'}});
            }
            if(this.RangAttackers.length < 0 ) {
                var newName = 'RangAttacker_' + Game.time;
                console.log('孵化新的 RangAttacker: ' + newName);
                spawn.spawnCreep([MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,RANGED_ATTACK,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL,HEAL], newName, {memory: {role: 'RangAttacker',workshop: 'E0S24'}});
            }
    ...
    w2S22Spawn1Incubator(spawn){
        ...
        if(this.Carriers_W2S22_G2.length < 1 && Game.getObjectById('5bbcb2c240062e4259e93d54').mineralAmount > 0){
            ...
            console.log('孵化新的 Carrier: ' + newName);
            spawn.spawnCreep([CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE], newName, {memory: {role: 'Carrier',workshop: 'W2S22',birthroom:'W2S22', group :2, taking: true}});
        }
        ...
        if(this.upgraders_W2S22.length < 1 ) {
