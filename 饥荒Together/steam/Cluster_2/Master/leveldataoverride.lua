return {
  custom_settings_desc="测试",
  custom_settings_id="CUSTOM_常用1",
  custom_settings_name="常用1",
  custom_worldgen_desc="测试",
  custom_worldgen_id="CUSTOM_常用1",
  custom_worldgen_name="常用1",
  desc="标准《饥荒》体验。",
  hideminimap=false,
